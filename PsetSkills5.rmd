...
gss_cat %>% 
filter(!(str_detect(rincome, "No answer|Not applicable"))) %>%  # I use str_detect to remove "No answer" and "Not applicable"
...
# I have introduced a new color pallette for fun:
